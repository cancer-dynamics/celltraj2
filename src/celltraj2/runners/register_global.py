...
from celltraj2.registration_batch import load_registration_job, run_batch_registration
...
def main(argv: list[str] | None = None) -> int:
    ...
    return run_reported(lambda reporter: run_batch_registration(job, reporter=reporter))
